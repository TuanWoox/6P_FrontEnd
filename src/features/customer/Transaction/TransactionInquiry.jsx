...
export default function TransactionInquiry() {
    ...
    return (
        <>
            <h1 className="text-3xl text-[#333333] font-bold">
                Tra cứu giao dịch
            </h1>
                ...
                <ol className="list-none p-0 inline-flex items-center">
                    <span className="text-gray-800 text-lg flex flex-column items-center">
                        <span>
                            <Link
                                to="/customer"
                                className="group transition duration-300 flex flex-column items-center hover:text-[#96C576]"
                            >
                                <HomeIcon className="w-4 h-4 mr-2 text-gray-600 group-hover:text-[#96C576] transition duration-300" />{" "}
                                Trang chủ
                            </Link>
                        </span>
                        / Lịch sử giao dịch
            ...
            <form action={handleSubmit} className="mb-8">
                <div className="bg-[#F1F2F2] flex justify-between flex-wrap max-w-screen-md w-full mx-auto h-fit rounded-2xl px-8 py-3 shadow-lg shadow-gray-300/60">
                    ...
                    <p className="text-xs w-full text-center mt-3">
                        ...
                        vòng 1 năm với khoảng thời gian tối đa trong một lầm tìm
                        kiếm là 31 ngày
                    </p>
            ...
            <div className="flex flex-col gap-3 w-full max-w-4xl mx-auto bg-gray-100 p-4 rounded-b-2xl shadow-md max-h-89 h-89 overflow-y-auto">
                {loading ? (
                    ...
                    <div className="text-center text-2xl py-8 text-red-500">
                        {error}
                    </div>
