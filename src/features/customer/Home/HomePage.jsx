            ...
            <div className="w-full max-w-5xl mx-auto mt-4 p-4">
                ...
                <div className="flex gap-35 mt-10">
                    <HomeButton
                        ...
                        label={<>Thông tin <br /> Cá nhân</>}
                        icon={<IdentificationIcon className="text-emerald-500 w-15" />}
                    />
                    <HomeButton
                        link="customer/change-password"
                        label={<>Cài đặt <br /> mật khẩu</>}
                        icon={<Cog6ToothIcon className="text-emerald-500 w-15" />}
                    />
                    <HomeButton
                        link="customer/set-limit"
                        label={<>Cài đặt <br /> Hạn mức</>}
                        icon={<AdjustmentsHorizontalIcon className="text-emerald-500 w-15" />}
                    />
                </div>
            </div>
        </div>
