import { MagnifyingGlassIcon, DevicePhoneMobileIcon, BanknotesIcon, CurrencyDollarIcon, DocumentTextIcon } from "@heroicons/react/16/solid";
...
function HomePage() {
    return (
        <div className="homepage">
            ...
            <div className="w-full max-w-7xl h-[400px] mx-auto bg-cover bg-center relative p-24 rounded-2xl drop-shadow-lg flex flex-col justify-center"
                style={{
                    backgroundImage:
            ...
            <div className="w-full max-w-7xl mx-auto mt-12 p-4 ">
                <h1 className="text-3xl font-semibold">Dịch vụ ngân hàng</h1>
                <div className="flex gap-50 mt-10">
                    <HomeButton link="/" label={<>Tiền gửi <br /> Tiết kiệm</> } icon={<BanknotesIcon className="text-emerald-500 w-25"/>}/>
                    <HomeButton link="/" label={<>Danh sách <br />vay</>} icon={<DocumentTextIcon className="text-emerald-500 w-25"/>}/>
                </div>
            </div>
        </div>
    )
