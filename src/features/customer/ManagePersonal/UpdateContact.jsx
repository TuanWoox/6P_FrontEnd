...
const PersonalInforBreadcrumbs = [
    ...
    { label: "Cập nhật thông tin cá nhân", path: "/customer/personal-infor/update-contact", isCurrent: true }, // Mark the last item as current
];
        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="mx-auto p-4">
                ...
                <div className="max-w-6xl mx-auto p-6 border-3 border-[#96C576] rounded-lg flex">
                    {/* Left Section */}
                    <div className="flex-1/2 flex flex-col justify-start gap-4 mb-6 p-4 border-r-2 border-gray-300">
                        ...
                        <InputField
                            ...
                            defaultValue={personalInfo?.customerProfile?.fullName}
                        ...
                        <InputField
                            ...
                            defaultValue={personalInfo.customerProfile?.phoneNumber}
                            rules={{ required: "Vui lòng nhập số điện thoại", pattern: { value: /^(0|\+84)[3|5|7|8|9][0-9]{8}$/, message: "Số điện thoại không hợp lệ" } }}
                            control={control}
                            error={errors.customer?.phoneNumber}
                            type="phone" // Đặc biệt với phone input
                        />
                    </div>

                    {/* Right Section */}
                    <div className="flex-1/2 flex flex-col justify-start gap-4 mb-6 p-4">
                        ...
                        <InputField
                            ...
                            defaultValue={personalInfo?.customerProfile?.address}
                            ...
                            rules={{
                                ...
                                validate: async (value) => {
                                    ...
                                    try {
                                      ...
                                      return error.message || "Không thể kiểm tra email";
                                    }
                                  }
                            }}
                            control={control}
                ...
                <div className="flex justify-center mt-3">
                    <button
                        type="button"
                        className="bg-[#95C475] hover:bg-white hover:text-[#95C475] hover:border-[#95C475] border-2 text-white py-2 px-6 rounded-2xl w-1/2"
