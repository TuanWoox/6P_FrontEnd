    ...
    <div className="mx-auto p-4">
      ...
      <div className="max-w-screen-lg mx-auto bg-gray-100 p-4 rounded-b-2xl shadow-md max-h-129">
        {isLoading ? (
          ...
          <p className="text-red-500">Không tìm thấy thông tin thanh toán.</p>
        ) : (
          <div className="p-6 rounded-lg mb-6">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="font-medium">{paymentDetail._id}</div>
            </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="font-medium">{loanDetail.accountNumber}</div>
            </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="font-medium text-red-500">
                {paymentDetail.amount?.toLocaleString("vi-VN")} VND
              </div>
            </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="font-medium">{paymentDetail.status}</div>
            </div>
