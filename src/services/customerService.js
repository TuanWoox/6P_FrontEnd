...
export const getInformationForSideBar = async () => {
    try {
        ...
        const errMsg =
            ...
            "Không thể lấy thông tin cho SideBar";
        throw { message: errMsg };
    }
};
export const getCustomerID = async (data) => {
    try {
        const response = await axiosAuth.post(
            `${API_URL}/customer/getCustomerID`,
            data,
        );
        return response.data;
    } catch (err) {
...
export const resetPassword = async (data) => {
    try {
        const response = await axiosAuth.post(
            `${API_URL}/customer/resetPassword`,
            data,
            {
...
export const getPersonalInfo = async () => {
    try {
        const response = await axiosAuth.get(
            `${API_URL}/customer/getPersonalInfor`,
        );
        return response.data;
    } catch (err) {
        const errMsg =
...
export const updatePersonalInfo = async (data) => {
    try {
        const response = await axiosAuth.post(
            `${API_URL}/customer/updatePersonalInfor`,
            data,
            {
                withCredentials: true,
            },
